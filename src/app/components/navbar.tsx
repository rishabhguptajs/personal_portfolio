...
const Navbar: React.FC = () => {
  return (
    <nav className='rounded-md flex flex-row justify-between w-full bg-gray-900/90 p-2 items-center'>
        ...
        <ul className='flex flex-row text-white p-2 justify-between w-[20%] mr-2'>
            ...
            <li>
                <a href="https://drive.google.com/file/d/1_Oci-76Dwxe2UNV43ymg204bORW_6vKg/view?usp=sharing" target='_blank' className='hover:underline'>Resume</a>
            </li>
            <li>
